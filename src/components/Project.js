        ...
        <section>
            <div className="w-full rounded-2xl">
                <div className="relative w-full">
                    ...
                    <PopularFlag/>
                    <span className="z-1 absolute left-3 bottom-3 text-white text-[18px] font-semibold">Quiz App</span>
                </div>
                <div className="flex flex-col gap-3 bg-primary-100 rounded-b-2xl w-full h-auto px-4 py-3">
                    <div className="flex flex-col">
                        <span className="text-primary-600 text-[14px] font-bold">CATEGORY:</span>
                        <DescriptionSecondary text={"Web Development"}/> 
                    </div>
                    <div className="flex flex-col">
                        <span className="text-primary-600 text-[14px] font-bold">PREQUISITES:</span>
                        <DescriptionSecondary text={"Prior knowledge of python required"}/> 
                    </div>
